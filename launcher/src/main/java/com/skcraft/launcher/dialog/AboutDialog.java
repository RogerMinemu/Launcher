...
public class AboutDialog extends JDialog {
    ...
    private void initComponents() {
        ...
        container.add(new JLabel("<html>Minemu Launcher, Fork de SKCraft Launcher<br>" +
        ...
        sourceCodeButton.addActionListener(ActionListeners.openURL(this, "https://minemu.es/launcher"));
    }
